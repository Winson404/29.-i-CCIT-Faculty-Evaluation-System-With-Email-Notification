<title>i-CCIT Faculty Evaluation System| Dean's info</title>
<?php 
    include 'navbar.php';
        ...
        <div class="row">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Dean's info</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
              ...
              <div class="card-body">
                  <div class="row p-2">
                    ...
                    <div class="col-lg-3 col-md-6 col-12 text-dark">
                      ...
                      <p class="text-center text-sm text-muted">Dean's photo</p>
                    </div>  
                  </div>
                 
              </div>
              <div class="card-footer float-right">
                <a href="dean.php" class="btn bg-secondary"><i class="fa-solid fa-circle-left"></i> Back to list</a>
