<title>i-CCIT Faculty Evaluation System | Verified student records</title>
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header p-2">
                <a href="users_verified_print.php" class="btn btn-success btn-sm float-sm-right mr-2"><i class="fa-solid fa-print"></i> Print</a>
