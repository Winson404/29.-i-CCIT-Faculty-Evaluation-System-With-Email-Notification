<?php 
	...
	if(isset($_POST['update_subject'])) {
		...
		$fetch = mysqli_query($conn, "SELECT * FROM subject WHERE name='$name' AND code='$code' AND units='$units' AND section_Id='$section_Id' AND instructor_Id='$instructor_Id' AND sub_Id!='$sub_Id' ");
		if(mysqli_num_rows($fetch) > 0) {
			...
			$fetch = mysqli_query($conn, "SELECT * FROM subject WHERE name='$name' AND section_Id='$section_Id' AND sub_Id !='$sub_Id' ");
			if(mysqli_num_rows($fetch) > 0) {
