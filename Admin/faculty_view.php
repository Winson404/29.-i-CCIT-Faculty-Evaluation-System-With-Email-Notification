<title>i-CCIT Faculty Evaluation System| Faculty's info</title>
<?php 
    include 'navbar.php';
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row">
          <div class="col-sm-6">
            <h3>Faculty's info</h3>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="dashboard.php">Home</a></li>
              <li class="breadcrumb-item active">Faculty's info</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
              ...
              <div class="card-body">
                  <div class="row p-2">
                    ...
                    <div class="col-lg-3 col-md-6 col-12 text-dark">
                      ...
                      <p class="text-center text-sm text-muted">Faculty photo</p>
                    </div>  
                  </div>
                 
              </div>
              <div class="card-footer float-right">
                <a href="faculty.php" class="btn bg-secondary"><i class="fa-solid fa-circle-left"></i> Back to list</a>
