<title>i-CCIT Faculty Evaluation System | Verified student reports</title>
<?php  
    include 'navbar.php'; 
?>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Verified student reports</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="profile.php">Home</a></li>
              <li class="breadcrumb-item active">Verified student reports</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
          ...
          <div class="card-header">
            ...
            <div class="card-body">
              <div id="printElement">
                ...
                <hr>
                <p class="text-center"><b>VERIFIED STUDENT RECORDS</b></p>
                <table id="example111" class="table table-bordered table-hover text-sm">
                  ...
                  <tbody id="users_data">
                      <?php 
                        $i = 1;
                        $sql = mysqli_query($conn, "SELECT * FROM users JOIN section ON users.year_section=section.section_Id WHERE user_type = 'Student' AND student_status=1 ORDER BY firstname");
