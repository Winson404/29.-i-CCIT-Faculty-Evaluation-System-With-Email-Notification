<title>i-CCIT Faculty Evaluation System | Faculty reports</title>
<?php  
    include 'navbar.php'; 
?>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Faculty reports</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
        ...
        <div class="card p-3">
          <div class="card-header">
            <button id="printButton" class="btn btn-success btn-sm float-sm-right mb-3"><i class="fa-solid fa-print"></i> Print</button>
             <a href="faculty.php" type="button" class="btn btn-secondary btn-sm float-sm-right mr-2"><i class="fa-solid fa-backward"></i> Back</a>
          </div>
            <div class="card-body">
              <div id="printElement">
                ...
                <hr>
                <p class="text-center"><b>FACULTY RECORDS</b></p>
