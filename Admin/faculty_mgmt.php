<title>i-CCIT Faculty Evaluation System | Faculty info</title>
<?php 
    include 'navbar.php'; 
    if(isset($_GET['page'])) {
      $page = $_GET['page'];
              ...
              <div class="card">
                    ...
                    <div class="row">
                      ...
                      <!--   <div class="col-lg-2 col-md-6 col-sm-6 col-12">
                        ...
                        <div class="col-lg-8 col-md-8 col-sm-6 col-12">
                            <div class="form-group">
                              <span class="text-dark"><b>Faculty photo</b></span>
                              <div class="input-group">
                ...
                <div class="card-footer">
                  <div class="float-right">
                    <a href="faculty.php" class="btn bg-secondary"><i class="fa-solid fa-backward"></i> Back to list</a>
                    <button type="submit" class="btn bg-primary" name="create_faculty" id="create_admin"><i class="fa-solid fa-floppy-disk"></i> Submit</button>
                  </div>
                </div>
              </div>
            </form>
          ...
          <form action="process_update.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="card">
              ...
              <div class="card-footer">
                <div class="float-right">
                  <a href="faculty.php" class="btn bg-secondary"><i class="fa-solid fa-backward"></i> Back to list</a>
                  <button type="submit" class="btn bg-primary" name="update_faculty" id="create_admin"><i class="fa-solid fa-floppy-disk"></i> Submit</button>
                </div>
              </div>
            </div>
          </form>
